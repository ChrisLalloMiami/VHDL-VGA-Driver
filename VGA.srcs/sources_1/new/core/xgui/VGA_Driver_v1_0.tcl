...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "ACTIVE_HEIGHT" -parent ${Page_0}
  ipgui::add_param $IPINST -name "ACTIVE_WIDTH" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "PIXEL_CLOCK_FREQ" -parent ${Page_0}
...
proc update_PARAM_VALUE.ACTIVE_HEIGHT { PARAM_VALUE.ACTIVE_HEIGHT } {
	# Procedure called to update ACTIVE_HEIGHT when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ACTIVE_HEIGHT { PARAM_VALUE.ACTIVE_HEIGHT } {
	# Procedure called to validate ACTIVE_HEIGHT
	return true
}

proc update_PARAM_VALUE.ACTIVE_WIDTH { PARAM_VALUE.ACTIVE_WIDTH } {
	# Procedure called to update ACTIVE_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.ACTIVE_WIDTH { PARAM_VALUE.ACTIVE_WIDTH } {
	# Procedure called to validate ACTIVE_WIDTH
	return true
}
...
proc update_PARAM_VALUE.PIXEL_CLOCK_FREQ { PARAM_VALUE.PIXEL_CLOCK_FREQ } {
	# Procedure called to update PIXEL_CLOCK_FREQ when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PIXEL_CLOCK_FREQ { PARAM_VALUE.PIXEL_CLOCK_FREQ } {
	# Procedure called to validate PIXEL_CLOCK_FREQ
	return true
}
...
proc update_MODELPARAM_VALUE.PIXEL_CLOCK_FREQ { MODELPARAM_VALUE.PIXEL_CLOCK_FREQ PARAM_VALUE.PIXEL_CLOCK_FREQ } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PIXEL_CLOCK_FREQ}] ${MODELPARAM_VALUE.PIXEL_CLOCK_FREQ}
}

proc update_MODELPARAM_VALUE.ACTIVE_WIDTH { MODELPARAM_VALUE.ACTIVE_WIDTH PARAM_VALUE.ACTIVE_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ACTIVE_WIDTH}] ${MODELPARAM_VALUE.ACTIVE_WIDTH}
}
...
proc update_MODELPARAM_VALUE.ACTIVE_HEIGHT { MODELPARAM_VALUE.ACTIVE_HEIGHT PARAM_VALUE.ACTIVE_HEIGHT } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.ACTIVE_HEIGHT}] ${MODELPARAM_VALUE.ACTIVE_HEIGHT}
}
