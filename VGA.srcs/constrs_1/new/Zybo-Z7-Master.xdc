# create_clock -add -name CLK_0 -period 8.00 -waveform {0 4} [get_ports { CLK_0 }];
set_property -dict {PACKAGE_PIN K17 IOSTANDARD LVCMOS33} [get_ports { CLK_0 }]
set_property -dict {PACKAGE_PIN T16 IOSTANDARD LVCMOS33} [get_ports { RSTN_0 }]
set_property -dict {PACKAGE_PIN V15 IOSTANDARD LVCMOS33} [get_ports { RGB_OUT_0[11] }]
set_property -dict {PACKAGE_PIN W15 IOSTANDARD LVCMOS33} [get_ports { RGB_OUT_0[10] }]
set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports { RGB_OUT_0[9] }]
set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports { RGB_OUT_0[8] }]
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports { RGB_OUT_0[7] }]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports { RGB_OUT_0[6] }]
set_property -dict {PACKAGE_PIN T12 IOSTANDARD LVCMOS33} [get_ports { RGB_OUT_0[5] }]
set_property -dict {PACKAGE_PIN U12 IOSTANDARD LVCMOS33} [get_ports { RGB_OUT_0[4] }]
set_property -dict {PACKAGE_PIN T14 IOSTANDARD LVCMOS33} [get_ports { RGB_OUT_0[3] }]
set_property -dict {PACKAGE_PIN T15 IOSTANDARD LVCMOS33} [get_ports { RGB_OUT_0[2] }]
set_property -dict {PACKAGE_PIN P14 IOSTANDARD LVCMOS33} [get_ports { RGB_OUT_0[1] }]
set_property -dict {PACKAGE_PIN R14 IOSTANDARD LVCMOS33} [get_ports { RGB_OUT_0[0] }]
set_property -dict {PACKAGE_PIN U14 IOSTANDARD LVCMOS33} [get_ports { HSYNC_0 }]
set_property -dict {PACKAGE_PIN U15 IOSTANDARD LVCMOS33} [get_ports { VSYNC_0 }]
...
#Pmod Header JC   connecting to PMOD VGA J1


#Pmod Header JD    connecting to PMOD VGA J2
